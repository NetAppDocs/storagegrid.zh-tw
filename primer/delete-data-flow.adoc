...
如需詳細資訊，請參閱 link:../ilm/how-objects-and-delete-markers-are-deleted.html["如何刪除物件和刪除標記"]。
...
image:delete_data_flow.png["用戶端刪除資料流程"]
...
image:automatic_deletion_data_flow.png["自動刪除資料流程"]
