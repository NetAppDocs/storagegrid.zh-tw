...
image:grid_manager_dashboard_and_menu.png["Grid Manager中的儀表板"]

若要了解每張卡片上顯示的資訊，請選擇該卡片的說明圖示 image:icon_nms_question.png["問號圖示"]。
...
說明選單 image:icon_help_menu_bar.png["功能表列上的說明圖示"] 提供以下項目的存取：
...
* 使用 link:../admin/grid-federation-overview.html["網格同盟"] 在兩個 StorageGRID 系統之間同步租戶帳戶資訊和複寫物件資料
...
* link:../monitor/configure-email-server.html["設定郵件伺服器"]
...
* link:../admin/about-multi-admin-verify.html["設定多管理員驗證"]
...
* link:../monitor/configure-autosupport-grid-manager.html["設定AutoSupport 功能"]
