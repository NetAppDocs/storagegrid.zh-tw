...
.選擇
* link:recovering-from-primary-admin-node-failures.html["使用同一個主要管理節點恢復主要管理節點"]
* link:recovering-from-primary-admin-node-failures-using-npan.html["使用非主要管理節點從主要管理節點故障中恢復"]
