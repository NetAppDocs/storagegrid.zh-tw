...
summary: 從「取消委任網站」精靈的步驟 4 （移除 ILM 參考）中、您必須刪除或編輯任何未使用的 ILM 規則、以參照該網站、即使這些規則未用於任何 ILM 原則。 
---
= 移除 StorageGRID 中對站台的 ILM 參照
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
** 若要刪除規則，請選擇垃圾桶圖示 image:icon_trash_can.png["圖示垃圾桶"] 並選擇 *OK*。
+
