---
permalink: maintain/restoring-audit-log-on-recovered-primary-admin-node-using-npan.html 
sidebar: sidebar 
keywords: storagegrid, restore audit log, primary admin node 
summary: 使用非主要管理節點還原已恢復的主要管理節點上的稽核日誌。 
---
= 在已恢復的主要管理節點上還原 StorageGRID 稽核日誌
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
