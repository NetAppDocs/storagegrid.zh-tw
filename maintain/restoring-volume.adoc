...
---
= 使用 StorageGRID Grid Manager 還原物件資料
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* 您已確認，在 Grid Manager 的 *Nodes* > *Overview* 標籤中，您正在還原物件的儲存節點的連線狀態為 *Connected* image:icon_alert_green_checkmark.png["圖示警示綠色核取記號"]。
* 您已確認下列事項：
+
** 用於新增儲存節點的網格擴充未在處理中。
** 儲存節點取消委任未在處理中或失敗。
