---
permalink: maintain/restoring-admin-node-database-primary-admin-node-using-npan.html 
sidebar: sidebar 
keywords: storagegrid, admin node database, primary admin node 
summary: 使用非主要管理節點恢復主要管理節點時，還原管理節點資料庫。 
---
= 恢復主要管理節點時，還原 StorageGRID 管理節點資料庫
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
