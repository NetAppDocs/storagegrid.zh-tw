...
* 所有網格節點均顯示正常（綠色）狀態image:icon_alert_green_checkmark.png["綠色核取記號圖示"]。如果在 *Health* 欄中看到以下圖示之一，則必須嘗試解決問題：
+
[cols="1a,1a,3a"]
|===
| 圖示 | 色彩 | 嚴重性 
 ...
 a| 
image:icon_alarm_yellow_notice.gif["黃色方塊圖示"]
 a| 
黃色
 a| 
注意
 ...
 a| 
image:icon_alert_yellow_minor.png["淺橘鑽石圖示"]
 a| 
淡橘色
 a| 
次要
 ...
 a| 
image:icon_alert_orange_major.png["暗橘鑽石圖示"]
 a| 
暗橘色
 a| 
主要
 ...
 a| 
image:icon_alert_red_critical.png["紅色x圖示"]
 a| 
紅色
 a| 
關鍵
