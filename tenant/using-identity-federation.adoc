...
image:tenant_shares_identity_federation.png["租戶共用身分識別聯盟"]
...
+
image:ldap_service_type.png["顯示LDAP服務類型選項的「身分識別聯盟」頁面"]
...
+
image:identity_federation_test_connection.png["驗證繫結使用者名稱格式的身分識別聯盟提示"]
