...
---
= 在 StorageGRID 中為 SAML 建立 Entra ID 企業應用程式
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
使用 Entra ID 為系統中每個 Admin Node 建立一個適用於 SAML 的企業應用程式。
...
== 步驟 2：建立企業應用程式並儲存 StorageGRID SSO 組態
...
. link:../admin/configure-sso-saml.html#test-sso["測試每個應用程式"]。
