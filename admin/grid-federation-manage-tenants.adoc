...
+
image:grid-federation-tenant-detail.png["租戶詳細資料頁面中的網格同盟索引標籤"]
...
image:grid-federation-remove-permission.png["移除網格同盟連線的步驟"]
...
+
image:grid-federation-remove-permission-error.png["如果租戶已啟用貯體的 cgrr 、則會顯示錯誤訊息"]
