...
image:grid-federation-cgr-workflow.png["跨網格複寫工作流程"]
...
image:grid-federation-cross-grid-replication-one-direction.png["顯示單向網格同盟連線的影像"]
...
image:grid-federation-cross-grid-replication.png["影像顯示複寫的單一方向、與雙向複寫比較"]
...
image:grid-federation-cross-grid-replication-delete.png["顯示在兩個網格上複寫用戶端刪除的影像"]
