...
+
--
如果您打算使用 S3 虛擬託管式請求，則應該link:../admin/configuring-s3-api-endpoint-domain-names.html["已設定 S3 端點網域名稱"]。建議使用虛擬託管式請求。
...
--
設定任何網格同盟連線:: 如果您希望允許 S3 租戶使用網格聯合連線將帳戶資料同步並複寫儲存桶物件到另一個網格，請在啟動精靈之前確認以下內容：
+
--
