...
+
image:ha_group_add_interfaces.png["HA群組新增介面"]
...
+
image:vlan_parent_interface_tooltip.png["VLAN介面工具秘訣"]
...
+
image:ha_group_determine_failover.png["HA群組決定優先順序"]
...
+
image:ha_group_select_virtual_ips.png["HA群組會輸入VIP"]
