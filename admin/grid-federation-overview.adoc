...
image:grid-federation-workflow.png["網格同盟連線工作流程"]
...
+
有關版本要求的詳細資訊，請參閱 https://library.netapp.com/ecm/ecm_download_file/ECMLP3351267["版本資訊"^]。您必須使用 NetApp 帳戶登入或建立帳戶，才能存取版本資訊。
...
image:grid-federation-certificates.png["網格同盟憑證"]
