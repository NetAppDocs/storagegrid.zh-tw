...
image:dashboard_health_panel_license_status.png["儀表板健全狀況狀態卡授權狀態"]
...
** 支援結束日期
+
此日期是從目前的授權檔案中讀取的，如果您在取得授權檔案後延長或續約了支援服務合約，則此日期可能已過期。若要更新此值，請參閱 link:updating-storagegrid-license-information.html["更新StorageGRID 版本的授權資訊"]。您也可以使用 Digital Advisor 檢視實際的合約到期日期。
