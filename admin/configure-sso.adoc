...
summary: 您可以依照「設定 SSO」精靈的步驟進入沙盒模式，在為所有 StorageGRID 使用者啟用單一登入 （SSO） 之前，對其進行設定和測試。啟用 SSO 後，您可以視需要返回沙盒模式來變更或重新測試組態。 
---
...
[[enter-sandbox-modeprovide-relying-party-identifier]]
