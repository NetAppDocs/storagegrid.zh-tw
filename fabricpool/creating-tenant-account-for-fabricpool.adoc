...
. 對於「定義根目錄存取」步驟、請根據您的 StorageGRID 系統使用link:../admin/using-identity-federation.html["身分識別聯盟"]、link:../admin/how-sso-works.html["單一登入（ SSO ）"]或兩者、指定哪個使用者將擁有租戶帳戶的初始根目錄存取權限。
+
[cols="1a,2a"]
|===
| 選項 | 請這麼做 
