...
---
= 了解 StorageGRID FabricPool 設定精靈
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* 如果您打算使用 S3 虛擬託管風格的請求，則需要link:../admin/configuring-s3-api-endpoint-domain-names.html["已設定 S3 端點網域名稱"]。ONTAP 預設使用路徑風格的 URL，但建議使用虛擬託管風格的請求。
