...
* 您有link:../admin/admin-group-permissions.html["儲存設備管理員或根存取權限"]。
...
+
image:autosupport_santricity_home_page.png["首頁AutoSupport SANtricity"]
...
+
image:autosupport_santricity_operations.png["營運AutoSupport SANtricity AutoSupport"]
...
+
image:autosupport_configure_delivery_santricity.png["執行不需執行的功能AutoSupport AutoSupport SANtricity"]
