...
NOTE: 若要使用 SANtricity System Manager 為 E 系列 AutoSupport 設定 Proxy，請參閱link:sending-eseries-autosupport-messages-through-storagegrid.html["透過 StorageGRID 傳送 E 系列 AutoSupport 套件"]。
...
image:nodes_page_santricity_tab.png["節點頁SANtricity 面「鏈結」索引標籤"]
