...
+
image:grid-federation-connections-tab.png["網格同盟連線索引標籤"]
...
+
image:grid-federation-permitted-tenants-tab.png["Grid Federation 的「允許租戶」標籤"]
...
+
image:grid-federation-permitted-tenants-tab-for-connection.png["GRID - Federation 允許的租戶 - 標籤 - 連線"]
...
+
image:grid-federation-certificates-tab.png["GRID 同盟憑證索引標籤"]
