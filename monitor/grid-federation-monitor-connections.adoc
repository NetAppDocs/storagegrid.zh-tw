...
+
image:grid_federation_connections_tab.png["網格同盟連線索引標籤"]
...
+
image:grid_federation_permitted_tenants_tab.png["Grid Federation 的「允許租戶」標籤"]
...
+
image:grid_federation_permitted_tenants_tab_for_connection.png["GRID - Federation 允許的租戶 - 標籤 - 連線"]
...
+
image:grid_federation_certificates_tab.png["GRID 同盟憑證索引標籤"]
