...
+
image:alerts_create_custom_rule.png["警報 > 建立自訂規則"]
...
+
若要查看可用指標並測試 Prometheus 運算式，請選擇說明圖示 image:icon_nms_question.png["問號圖示"] 並點擊連結進入 Grid Management API 的 Metrics 區段。
