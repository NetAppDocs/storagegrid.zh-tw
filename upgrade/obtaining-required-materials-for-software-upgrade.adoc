...
本文檔StorageGRID
 a| 
* https://library.netapp.com/ecm/ecm_download_file/ECMLP3373065["版本資訊"^]。您必須登入現有 NetApp 帳戶或建立帳戶才能存取發行說明。請務必在開始升級前仔細閱讀這些說明。
* https://kb.netapp.com/hybrid/StorageGRID/Maintenance/StorageGRID_12.1_software_upgrade_resolution_guide["StorageGRID 軟體升級解決方案指南"^]您要升級至的主要版本（需要登入）
