...
image:rhel_node_configuration_file_output.gif["此影像由周邊文字說明。"]
...
image:rhel_node_configuration_file_output_with_errors.gif["此影像由周邊文字說明。"]
