...
---
= 使用 VMware vSphere 將網格節點部署為 StorageGRID 的虛擬機
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
如果您的企業連網原則限制對 StorageGRID 所使用的一個或多個連接埠的存取，則可能需要重新對應連接埠。請參閱 link:../network/index.html["網路準則"] 以了解 StorageGRID 使用的連接埠。
