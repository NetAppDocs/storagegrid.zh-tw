...
+
--
請參閱 link:../network/index.html["網路準則"]。
...
--
節點遷移（如果需要，僅限 Ubuntu 和 Debian）:: link:node-container-migration-requirements.html["節點移轉需求"]如果您想在不中斷任何服務的情況下、於實體主機上執行排程維護、請瞭解。
...
+
--
* https://library.netapp.com/ecm/ecm_download_file/ECMLP3373065["版本資訊"^]。您必須登入現有 NetApp 帳戶或建立帳戶才能存取發行說明。
