...
---
= StorageGRID 中用於保護映像檔案的 ILM 規則和原則
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
|===
image:policy_3_rule_1_ec_images_adv_filtering.png["ILM規則1例如3：將EC用於大於1 MB的映像檔"]
...
image:policy_3_configured_policy.png["範例3的ILM原則：為映像檔提供更好的保護"]
