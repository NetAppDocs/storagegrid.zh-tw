...
---
= 在 StorageGRID 中使用 ILM 原則和 ILM 規則
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. 選取您要檢視其詳細資料的規則名稱。範例：
+
image:ilm_rule_details_page.png["ILM 規則詳細資料頁面"]
...
. 監控 ILM 索引標籤上的度量。
+
您可以選取問號 image:icon_nms_question.png["問號圖示"] 以查看 ILM 索引標籤上的項目說明。

+
image:ilm_metrics_on_dashboard.png["Grid Manager 儀表板上的 ILM 計量"]
