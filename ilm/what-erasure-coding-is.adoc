...
image:ec_three_sites_4_plus_2.png["銷毀編碼三個站台4 Plus 2"]
...
image:ec_recoverable_4_plus_2.png["可恢復的銷毀編碼4 Plus 2"]

如果遺失兩個以上的儲存節點、則無法擷取物件。

image:ec_unrecoverable_4_plus_2.png["無法恢復的銷毀編碼4 Plus 2"]
