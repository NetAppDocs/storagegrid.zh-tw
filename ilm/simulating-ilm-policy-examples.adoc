...
image:simulate_policy_screen.png["模擬原則結果"]
...
+
image:simulate_reorder_rules_pngs_result.png["範例 2 ：模擬 ILM 原則時重新排序規則"]
...
+
image:simulate_reorder_rules_correct_result.png["範例 2 ：模擬 ILM 原則時重新排序規則"]
...
image:simulate_results_for_object_wrong_metadata.png["範例 3 ：模擬 ILM 原則時修正規則"]
...
+
image:simulate_results_for_object_corrected_metadata.png["範例 3 ：模擬 ILM 原則時修正規則"]
