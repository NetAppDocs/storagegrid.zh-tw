...
. 判斷節點的硬體是否離線。
. 如果您的 StorageGRID 系統已啟用單一登入 （SSO），請參閱使用 link:../admin/learn-about-setting-up-sso-oidc.html["OIDC"] 或 link:../admin/learn-about-setting-up-sso-saml.html["SAML"] 設定 SSO。
+
